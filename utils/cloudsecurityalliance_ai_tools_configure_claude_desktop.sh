...
Please review the script contents before running:
https://github.com/cloudsecurityalliance/CSA-AI-Tool-Setup/blob/main/utils/cloudsecurityalliance_ai_tools_configure_claude_desktop.sh
...
create_config_file() {
    ...
    if ! echo "$config_content" > "$target_path"; then
...
main() {
    echo "Starting Cloud Security Alliance AI Tools Configuration for Claude Desktop..."
    echo
